...
follower_one_layer = Chef::DataBagItem.load("aws_opsworks_layer", "rabbitmq-follower-one").to_hash
follower_one_layer_id = follower_one_layer["layer_id"]

follower_two_layer = Chef::DataBagItem.load("aws_opsworks_layer", "rabbitmq-follower-two").to_hash
follower_two_layer_id = follower_two_layer["layer_id"]
...
rabbitmq_nodes = opsworks_instances.select { |instance|
  ...
  instance["layer_ids"].include?(follower_one_layer_id) ||
  instance["layer_ids"].include?(follower_two_layer_id)
